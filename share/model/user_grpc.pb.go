...
const (
	...
	Users_Add_FullMethodName      = "/model.Users/Add"
)
...
type UsersClient interface {
	...
	Add(ctx context.Context, in *User, opts ...grpc.CallOption) (*emptypb.Empty, error)
}
...
func (c *usersClient) Add(ctx context.Context, in *User, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	out := new(emptypb.Empty)
	err := c.cc.Invoke(ctx, Users_Add_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type UsersServer interface {
	...
	Add(context.Context, *User) (*emptypb.Empty, error)
...
func (UnimplementedUsersServer) Add(context.Context, *User) (*emptypb.Empty, error) {
